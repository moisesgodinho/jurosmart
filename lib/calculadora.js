export function calcularJurosCompostos(valorInicial, aporteMensal, taxaJuros, tempo, aumentoAporteAnual = 0) {
  ...
  // Com os aportes variáveis, o 'totalInvestido' calculado dentro do loop já é o valor correto.
  return {
